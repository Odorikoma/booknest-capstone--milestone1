    ...
    card.innerHTML = `
      ...
      <div class="p-4">
        ...
        <div class="mt-4 flex justify-between">
          <a href="${API_BASE_URL}/borrow.html?id=${book.id}" class="text-indigo-600 hover:underline text-sm font-medium">Borrow</a>
          <a href="${API_BASE_URL}/book-detail.html?id=${book.id}" class="text-blue-600 hover:underline text-sm font-medium">Detail</a>
        </div>
      </div>
    `;
